            ...
            <section className="background-image container my-5" id="seccion-principal">
                <div className="row align-items-center">
                    <div className="col-md-6 text-center text-md-start">
                        <h1 className="display-4 fw-bold text-dark">Bienvenido al laboratorio interactivo 3D de MATEMÁTICAS</h1>
                        <p className="lead">Explorá y aprende MATEMÁTICAS de manera educativa e inmersiva.</p>
                        <div className="d-flex justify-content-center justify-content-md-start">
                            <Link to="#" className="btn btn-outline-dark me-2">Ver más</Link>
                            <Link to="/matematicas" className="btn btn-dark" id="iniciarBtn">Iniciar</Link> {/* Cambiado a Link */}
                        </div>
                    </div>
